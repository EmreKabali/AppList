...
export default async function HomePage({
  ...
  const initialView: ViewType =
    params.view === "active-test" ||
    params.view === "expired-test" ||
    params.view === "live"
      ? params.view
      : "live";
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Kartlara tıklayarak yayında ve test süreçlerini takip edin
          </p>
        </div>
        ...
        <Card className="mb-6 border-indigo-200 bg-indigo-50/40 hover:shadow-sm">
          ...
          <CardContent className="space-y-3 text-sm text-gray-700">
            <p>
              Aşağıdaki Google gruplara katılarak, gruptaki herkesi otomatik
              tester olarak eklemiş olursunuz.
            </p>
            ...
            <p className="text-gray-600">
              Google Grup mantığı: Play Console içinde tester olarak grup
              e-posta adresi tanımlanır; gruba katılan herkes tek tek ekleme
              yapmadan otomatik olarak teste erişebilir.
            </p>
          </CardContent>
        </Card>
